    ...
    while (logowanie.success == 1)
    {
        ...
        switch(dec)
        {
            ...
            case 3:
                ...
                {
                    msgsnd(kolejka, &zapytanie, sizeof(zapytanie)-sizeof(long), 0);
                    msgrcv(kolejka, &lista, sizeof(lista)-sizeof(long), 334, 0);
                    for(i=0; i<lista.ilosc; i++){
                        printf("%s\n", lista.positions[i]);
                    }
                }
            ...
            case 4:
                zapytanie.type = 444;
                msgsnd(kolejka, &zapytanie, sizeof(zapytanie)-sizeof(long), 0);
                msgrcv(kolejka, &lista, sizeof(lista)-sizeof(long), 445, 0);
                for(i=0; i<3; i++){
                    printf("%s\n", lista.positions[i]);
                }
                break;
            case 5:
                user.type = 555;
                printf("%s jestem tutaj nadal\n", user.log);
                // strcpy(user2.log, user.log);
                ...
                if (group < 4 && group > 0){
                    msgsnd(kolejka, &user, sizeof(user)-sizeof(long), 0);
                    printf("dupa\n");
                    msgrcv(kolejka, &odpowiedz, sizeof(odpowiedz)-sizeof(long), 556, 0);
            ...
            case 6:
                ...
                if (group<4 && group>0)
                {
                    if (user.sg[message.to_group] == 1)
                    {
                        ...
                        msgrcv(kolejka, &odpowiedz, sizeof(odpowiedz)-sizeof(long), 667, 0);
            ...
            case 7:
                ...
                msgsnd(kolejka, &message, sizeof(message)-sizeof(long), 0);
                msgrcv(kolejka, &odpowiedz, sizeof(odpowiedz)-sizeof(long), 778, 0);
                if (odpowiedz.success == 1) { printf("wiadomosc wyslana do uzytkownika.\n"); }
                else { printf("uzytkownik nie istnieje.\n"); }
                break;
            case 8:
                zapytanie.type = 888;
                printf("wciaz tutaj jestem %s\n", user.log);
                strcpy(zapytanie.text, user.log);
                msgsnd(kolejka, &zapytanie, sizeof(zapytanie)-sizeof(long), 0);
                msgrcv(kolejka, &odbior,sizeof(odbior)-sizeof(long),889,0);
